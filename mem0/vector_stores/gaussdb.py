...
class GaussDB(VectorStoreBase):
    ...
    def __init__(
        ...
        if auto_create:
            ...
            if self.collection_name not in collections:
                ...
                # Collection exists; verify BM25 index is actually present
    ...
    def create_col(self, name: Optional[str] = None, vector_size: int = None, distance: str = None) -> None:
        ...
        dims = self.embedding_model_dims if vector_size is None else _validate_positive_int(vector_size, "vector_size")
